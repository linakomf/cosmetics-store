export const topProducts = [
  ...
  },
  {
    ...
    name: 'Primer',
    price: '5,850 ₸',
    description: 'DARLING* lash cocoon. I am your WATERPROOF mascara that gently wraps each eyelash in a "COCOON" resistant to any external influences: tears, sweat, rain, even a pool will not deprive your eyes of EXPRESSIVENESS. The magic will disappear only when exposed to warm water at 38°C, without using additional products. Did we really create the perfect mascara?',
  ...
  },
  {
    ...
    price: '1,459 ₸',
    description: 'ESSENCE dip eyeliner. Waterproof eyeliner in a rich black color provides up to 24 hours of impeccable durability! Thanks to a softer applicator, the dip eyeliner waterproof 24h long-lasting from essence provides a pleasant, easy application.',
  ...
  },
  {
    ...
    name: 'Blush',
    price: '10,020 ₸',
    description: 'KIKO MILANO unlimited blush',
    image: 'https://images.verishop.com/westman-atelier-super-loaded-tinted-highlight/7804033728706-611752841?auto=format&cs=strip&fit=max&w=768&dpr=2',
  },
  {
    id: 6,
    name: 'Concealer',
    price: '4,390 ₸',
    description: 'MAYBELLINE NEW YORK the eraser eye. The Maybelline The Eraser Eye concealer quickly hides signs of fatigue, sleepless nights, stress, and refreshes sensitive skin. It refreshes dull skin and adds radiance to it. This product from Maybelline has a convenient applicator with a miniature sponge. The composition is easy and convenient to apply. The formula of The Eraser Eye is unique. It includes exotic components. Among them are healing goji berries. They provide active care for the eyelids. This concealer for the skin around the eyes will easily become your favorite. The concealer effectively masks circles under the eyes and eliminates the tired look.',
  ...
  },
  {
    ...
    name: 'Mascara',
    price: '2,520 ₸',
    description: 'Max Factor lash cocoon. The Darling* Mascara is a brush-on wonder that wraps each lash in a waterproof cocoon. Smudge-proof, swim-proof, and tear-proof, it promises long-lasting wear while adding intense volume to your lashes.',
    image: 'https://images.verishop.com/laura-mercier-real-flawless-foundation/7804033532098-2879903032?auto=format&cs=strip&fit=max&w=768&dpr=2',
  },
];
